    ...
    <div class="global-wrapper">
            ...
            <div class="nav__wrapper">
                <div class="list__wrapper container">
                    ...
                    <div class="burger__wrapper">
                        <button class="burger" id="burgerOpen">
                            <svg data-qa="Menu" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4 5h12M4 10h12M4 15h12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </button>
                    </div>
                    <div class="nav-mobile__wrapper close__visibility" id="navMobileWrapper">
                        <div class="nav-mobile__container">
                            <button class="nav-mobile__close" id="burgerClose">
                                <svg data-qa="Cross" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0)"><path d="m10 10-4.95 4.95m0-9.9L10 10 5.05 5.05ZM10 10l4.95 4.95L10 10Zm0 0 4.95-4.95L10 10Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M79-22H-51a5 5 0 0 0-5 5v54a5 5 0 0 0 5 5H79a5 5 0 0 0 5-5v-54a5 5 0 0 0-5-5Z" stroke="currentColor" stroke-dasharray="10 5"></path></g><defs><clipPath id="clip0"><path fill="currentColor" d="M0 0h20v20H0z"></path></clipPath></defs></svg>
                            </button>
        ...
        <main>
            ...
            <section class="check__section" id="check">
                <div class="check__wrapper container">
                    <div class="check__item">
                        <div class="check__img-wrapper check__color-blue">
                            <svg width="42" height="28" viewBox="0 0 42 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M41.4144 3.41421L17.0002 27.8284L0.0859375 10.9142L2.91436 8.08579L17.0002 22.1716L38.5859 0.585787L41.4144 3.41421Z" fill="white"></path>
                            </svg>
                        </div>
                    ...
                    <div class="check__item">
                        <div class="check__img-wrapper check__color-middle">
                            <svg width="42" height="28" viewBox="0 0 42 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M41.4144 3.41421L17.0002 27.8284L0.0859375 10.9142L2.91436 8.08579L17.0002 22.1716L38.5859 0.585787L41.4144 3.41421Z" fill="white"></path>
                            </svg>
                        </div>
                    ...
                    <div class="check__item">
                        <div class="check__img-wrapper check__color-green">
                            <svg width="42" height="28" viewBox="0 0 42 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M41.4144 3.41421L17.0002 27.8284L0.0859375 10.9142L2.91436 8.08579L17.0002 22.1716L38.5859 0.585787L41.4144 3.41421Z" fill="white"></path>
                            </svg>
                        </div>
            ...
            <section class="question__section" id="question">
                <div class="question__wrapper container">
                    <div class="question__title-wrapper">
                        <h2>Часто задаваемые вопросы</h2>
                    </div>
                    <div class="questions__row-wrapper">
                        <div class="question__items-wrapper">
            ...
            <section class="special__section special__gradient" id="special">
                <div class="special__section-wrapper container">
                    ...
                    <div class="special-form__wrapper">
                        <script data-b24-form="inline/109/bzz55m" data-skip-moving="true">(function(w,d,u){var s=d.createElement('script');s.async=true;s.src=u+'?'+(Date.now()/180000|0);var h=d.getElementsByTagName('script')[0];h.parentNode.insertBefore(s,h);})(window,document,'https://crm-online24.ru/upload/crm/form/loader_109_bzz55m.js');</script>
                    </div>
                </div>
            </section>
            ...
            <section class="callback__section" id="callback">
                <div class="callback__wrapper container">
                    <div class="callback__container-desc">
                        <div class="callback__title">
                            <h2>Остались вопросы? Интересно?</h2>
                        </div>
                        <div class="callback__description">
                            <span>Оставьте заявку и наш специцалист свяжется с вами в течении 5 минут</span>
                        </div>
                    </div>
            ...
            <div class="footer container">
                <div class="footer__contacts">
                    ...
                    <div class="footer__contacts-description">
                        <span>
                            Вы можете связаться с нами в любым удобным способом или заказать звонок
                        </span>
                    </div>
                ...
                <div class="footer__form">
                    ...
                    <div class="footer__form-wrapper">
                        <script data-b24-form="inline/110/ox6frk" data-skip-moving="true">(function(w,d,u){var s=d.createElement('script');s.async=true;s.src=u+'?'+(Date.now()/180000|0);var h=d.getElementsByTagName('script')[0];h.parentNode.insertBefore(s,h);})(window,document,'https://crm-online24.ru/upload/crm/form/loader_110_ox6frk.js');</script>
                    </div>
                </div>
            </div>
        </footer>
